...
public class Promo {
	...
	public void setup() throws Exception {
		...
		testDataMap = TestDataUtils.readFromFileAndConvertToMap(new File("src/test/resource/testdata/AOSLSE.csv"));
			...
			htmlReporter = new ExtentHtmlReporter(new File(System.getProperty("user.dir")+"/target/AOSLSEPromo.html"));
	...
	public void promo() {
		 ...
		 */
				...
				resp = given().body("voucherId=AOS30").
						pathParameter("guid", generatedCartID).
				...
				System.out.println("Completed Promo Scenario");
